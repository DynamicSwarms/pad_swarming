...
inline double slider_value_to_height(int slider_value)
{
    ...
    public:
            ...
            , m_control_connection(control_connection)
        {
            ...
            m_control_connection->get_target(current_target);
            ...
            connect(m_ui.z_slider, &QSlider::valueChanged, this, [this](int value) {
                ...
                m_control_connection->set_target(Eigen::Vector3d(m_coordinate_widget->selectedPoint().x(), m_coordinate_widget->selectedPoint().y(), height));
            });
        }
