...
class AddApi:
    ...
    def __init__(self, node: Node):
        ...
        self._add_hardware_client = self._node.create_client(
            AddHardwareCrazyflie, "crazyflie_hardware_gateway/add_crazyflie"
        )
        self._remove_hardware_client = self._node.create_client(
            RemoveHardwareCrazyflie, "crazyflie_hardware_gateway/remove_crazyflie"
        )
        self._add_webots_client = self._node.create_client(
            WebotsCrazyflie, "crazyflie_webots_gateway/add_crazyflie"
        )
        self._remove_webots_client = self._node.create_client(
            WebotsCrazyflie, "crazyflie_webots_gateway/remove_crazyflie"
        )
